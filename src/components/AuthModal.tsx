  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-md p-4 animate-in fade-in duration-200">
      <div className="bg-white border border-slate-200/90 rounded-3xl max-w-md w-full p-6 sm:p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="absolute -top-28 -right-28 w-56 h-56 bg-indigo-500/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -bottom-28 -left-28 w-56 h-56 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none" />

        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-slate-400 hover:text-slate-700 p-2 rounded-xl hover:bg-slate-100 transition border border-transparent"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-tr from-indigo-600 to-violet-600 text-white mb-3 shadow-md shadow-indigo-600/20">
          ...
          <p className="text-xs text-slate-500 mt-1">Select your Semester & Batch to access tailored quizzes</p>
        </div>
          ...
          <form onSubmit={handleStudentSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10 text-xs font-medium"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10 text-xs font-mono font-semibold"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 focus:outline-none focus:bg-white focus:border-indigo-500 text-xs font-medium"
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 focus:outline-none focus:bg-white focus:border-indigo-500 text-xs font-mono font-medium"
                >
            ...
            <div>
              <label className="block text-[11px] font-bold text-emerald-700 uppercase tracking-wider mb-1.5 flex items-center justify-between">
                <span className="flex items-center gap-1">
                  <Layers className="w-3.5 h-3.5" /> Select Current Semester
                </span>
                <span className="text-[10px] text-slate-500 font-normal">Auto-synced</span>
              </label>
              <select
                value={selectedSemesterCode}
                onChange={(e) => setSelectedSemesterCode(e.target.value as SemesterCode)}
                className="w-full px-4 py-2.5 rounded-xl bg-emerald-50/60 border border-emerald-300 text-emerald-900 font-bold focus:outline-none focus:bg-white focus:border-emerald-500 text-xs font-mono"
              >
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-indigo-600 via-violet-600 to-indigo-600 hover:from-indigo-500 hover:to-violet-500 text-white font-bold rounded-xl shadow-md shadow-indigo-600/20 transition flex items-center justify-center gap-2 mt-6 text-xs"
            >
          ...
          <form onSubmit={handleFacultySubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-amber-500 text-xs"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-amber-500 text-xs font-mono font-semibold"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-500 hover:to-orange-500 text-white font-bold rounded-xl shadow-md shadow-amber-600/20 transition flex items-center justify-center gap-2 mt-6 text-xs"
            >
